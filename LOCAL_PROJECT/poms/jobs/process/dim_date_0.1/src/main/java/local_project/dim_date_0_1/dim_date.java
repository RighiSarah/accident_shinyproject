...
package local_project.dim_date_0_1;
...
public class dim_date implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_date.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_dim_date = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_dim_date = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dim_date) {
	...
	public static class row1Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_dim_date.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_dim_date.length == 0) {
						commonByteArray_LOCAL_PROJECT_dim_date = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_dim_date = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_dim_date, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_dim_date,
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out1'
								out1_tmp.date_id = Numeric.sequence("s1", 1, 1);
								out1_tmp.date = DateHandling
										.localDateToDate(DateHandling
												.create_date(row1.an,
														row1.mois, row1.jour));
								out1_tmp.jour = row1.jour;
								out1_tmp.mois = row1.mois;
								out1_tmp.annee = row1.an;
								out1 = out1_tmp;
								// ###############################
							...
							if (out1 != null) {
								...
								row2 = null;
								finder_tUniqRow_1.date = out1.date;
								finder_tUniqRow_1.hashCodeDirty = true;
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

									new_tUniqRow_1.date = out1.date;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_date.class.getClassLoader()
					.getResourceAsStream(
							"local_project/dim_date_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = dim_date.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dim_date");
		}
...
/************************************************************************************************
 * 66843 characters generated by Talend Open Studio for Data Integration on the
 * 4 novembre 2018 18:13:54 CET
 ************************************************************************************************/

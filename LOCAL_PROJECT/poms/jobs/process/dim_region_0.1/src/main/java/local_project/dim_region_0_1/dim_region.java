...
package local_project.dim_region_0_1;
...
/**
 * Job: dim_region Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class dim_region implements TalendJob {
	...
	private final String jobName = "dim_region";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_region.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_dim_region = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_dim_region = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_dim_region.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_dim_region.length == 0) {
						commonByteArray_LOCAL_PROJECT_dim_region = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_dim_region = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_dim_region, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_dim_region, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_dim_region) {

				try {

					int length = 0;

					this.region_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.region_id, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"E:/M2/programmation avancée/projet/entrepot/dim_region.csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write("nom_region");
					outtFileOutputDelimited_1
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out1'
								out1_tmp.region_id = row1.reg;
								out1_tmp.nom_region = row1.region;
								out1 = out1_tmp;
								// ###############################
							...
							if (out1 != null) {
								...
								row2 = null;
								finder_tUniqRow_1.region_id = out1.region_id;
								finder_tUniqRow_1.hashCodeDirty = true;
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

									new_tUniqRow_1.region_id = out1.region_id;
									...
									row2.region_id = out1.region_id;
									row2.nom_region = out1.nom_region;
	...
	public static void main(String[] args) {
		final dim_region dim_regionClass = new dim_region();

		int exitCode = dim_regionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_region.class.getClassLoader()
					.getResourceAsStream(
							"local_project/dim_region_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_region.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dim_region");
		}
...
/************************************************************************************************
 * 64593 characters generated by Talend Open Studio for Data Integration on the
 * 4 novembre 2018 19:40:28 CET
 ************************************************************************************************/
